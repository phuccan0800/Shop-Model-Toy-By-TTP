...
<table width="460px" cellpadding="0" cellspacing="0">
    ...
    <td colspan="3" align="right">
        <input class='button5' type="button" value="Back" onclick="javascript:window.location='?page=shipment&cart=<?php echo($GLOBALS['cart']) ?>'" />        
        ...
        <input class='button5' type="submit" value="Next" />    
        </td>
    </tr>
</table>
</form>
